...
@interface MTGoodsDetailViewController ()
...
@implementation MTGoodsDetailViewController
...
{
    id <MTConfirmOrderServiceProtocol> provide = [MTProtocolManager serviceProvideForProtocol:@protocol(MTConfirmOrderServiceProtocol)];
